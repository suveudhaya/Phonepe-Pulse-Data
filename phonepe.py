...
# Execute SELECT queries and fetch data
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\suved\OneDrive\Desktop\pic.jpg"),width= 600)
    ...
    with tab1:
        ...
        if method == "Transaction Analysis":
            ...
            with col1:
                ...
                years= st.slider("Select The Year",Aggre_transaction["Years"].min(), Aggre_transaction["Years"].max(),Aggre_transaction["Years"].min(), key="transaction_year_slider")
            Aggre_tran_tac_Y= Transaction_amount_count_Y(Aggre_transaction, years)

            col1,col2= st.columns(2)
            with col1:
                states= st.selectbox("Select The State", Aggre_tran_tac_Y["States"].unique(), key="transaction_state_selectbox")
            ...
            with col1:
                ...
                quarters= st.slider("Select The Quarter",Aggre_tran_tac_Y["Quarter"].min(), Aggre_tran_tac_Y["Quarter"].max(),Aggre_tran_tac_Y["Quarter"].min(), key="transaction_quarter_slider")
            Aggre_tran_tac_Y_Q= Transaction_amount_count_Y_Q(Aggre_tran_tac_Y, quarters)

            col1,col2= st.columns(2)
            with col1:
                states= st.selectbox("Select The State_Ty", Aggre_tran_tac_Y_Q["States"].unique(), key="transaction_state_ty_selectbox")
            ...
            with col1:
                ...
                years= st.slider("Select The Year",Aggre_user["Years"].min(), Aggre_user["Years"].max(),Aggre_user["Years"].min(), key="user_year_slider")
            Aggre_user_Y= Aggre_user_plot_1(Aggre_user, years)

            col1,col2= st.columns(2)
            with col1:

                quarters= st.slider("Select The Quarter",Aggre_user_Y["Quarter"].min(), Aggre_user_Y["Quarter"].max(),Aggre_user_Y["Quarter"].min(), key="user_quarter_slider")
            Aggre_user_Y_Q= Aggre_user_plot_2(Aggre_user_Y, quarters)

            col1,col2= st.columns(2)
            with col1:
                states= st.selectbox("Select The State", Aggre_user_Y_Q["States"].unique(), key="user_state_selectbox")
    ...
    question= st.selectbox("Select the Question",["1. Comparison of Transaction Amount and Count between Aggregated Transaction and Top Transaction",
                                                    "2. Comparison of Registered Users between Map User and Top User",
                                                    "3. Comparison of App Opens between Map User and Top User",
    ...
    if question == "1. Comparison of Transaction Amount and Count between Aggregated Transaction and Top Transaction":

        st.subheader("Comparison of Transaction Amount")
        st.write("Transaction Amount of Aggregated Transaction:")
        top_chart_transaction_amount("aggregated_transaction")
        st.write("Transaction Amount of Top Transaction:")
        top_chart_transaction_amount("top_transaction")

        st.subheader("Comparison of Transaction Count")
        st.write("Transaction Count of Aggregated Transaction:")
        top_chart_transaction_count("aggregated_transaction")
        st.write("Transaction Count of Top Transaction:")
        top_chart_transaction_count("top_transaction")

    elif question == "2. Comparison of Registered Users between Map User and Top User":

        st.subheader("Comparison of Registered Users")
        st.write("Registered Users of Map User:")
        top_chart_registered_users("map_user")
        st.write("Registered Users of Top User:")
        top_chart_registered_users("top_user")

    elif question == "3. Comparison of App Opens between Map User and Top User":

        states = st.selectbox("Select the State", map_user["States"].unique())   
        st.subheader("Comparison of App Opens")
        st.write("App Opens of Map User:")
        top_chart_appopens("map_user", states)
        st.write("App Opens of Top User:")
        top_chart_appopens("top_user", states)
